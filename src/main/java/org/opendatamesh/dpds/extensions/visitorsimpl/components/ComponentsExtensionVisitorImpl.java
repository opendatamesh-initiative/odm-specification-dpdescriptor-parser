...
public class ComponentsExtensionVisitorImpl extends ExtensionVisitor implements ComponentsVisitor {
    ...
    public void visit(Port port) {
        extensionHandler.handleComponentBaseExtension(port, Components.class);
    ...
    public void visit(ApplicationComponent applicationComponent) {
        extensionHandler.handleComponentBaseExtension(applicationComponent, Components.class);
    ...
    public void visit(InfrastructuralComponent infrastructuralComponent) {
        extensionHandler.handleComponentBaseExtension(infrastructuralComponent, Components.class);
    ...
    public void visit(StandardDefinition standardDefinition) {
        extensionHandler.handleComponentBaseExtension(standardDefinition, Components.class);
